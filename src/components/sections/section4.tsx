...
<div className="w-full h-full bg-[#fcfaf3] py-10 mb-20">
  <div className="grid grid-cols-4 gap-4">
    ...
    <button className="text-white bg-yellow-600 py-3 px-8">Explore More</button></div>
    <div className=""><img src="/images/inspo.png" /></div>
    <div className=""><img src="/images/inspo2.png" /></div>
